...
public class WarehouseEntity {
    ...
    public void putStatistics(Long arrayId, int max, int min, double average, int numberOfPositiveElements, int numberOfNegativeElements) {
    ...
    public void updateStatistics(Long arrayId, int max, int min, double average, int numberOfPositiveElements, int numberOfNegativeElements) {

        if (storage.containsKey(arrayId)) {
            storage.replace(arrayId, new ArrayStatisticEntity(max, min, average, numberOfPositiveElements, numberOfNegativeElements));
        } else {
